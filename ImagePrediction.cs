...
public static class ImagePrediction {
    ...
    private static async Task MakePredictionRequest(byte[] image, ISocketMessageChannel channel, IUser author) {
        //Prediction endpoint
        const string url =
            "https://string-prediction.cognitiveservices.azure.com/customvision/v3.0/Prediction/31f1189e-9aa0-40df-acdc-cf9364a4836c/classify/iterations/NoAnime9/image";
